...
function Footer() {
  return (
    <footer className="h-40 w-full flex justify-center items-center text-white border-t mt-6 lg:mt-0">
      <div className="flex flex-col justify-between items-center w-full h-full">
        ...
        <p className="text-gray-400 text-xs px-6 lg:px-0 text-center pb-4 lg:pb-0">
